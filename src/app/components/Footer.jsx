...
export default function Footer() {
  ...
  return (
    <footer className="bg-[var(--bg-deep)] text-white pt-0 relative overflow-hidden">
      ...
      {/* Faixa do Discord */}
      <div className="relative bg-gradient-to-r from-[var(--primary-purple-dark)] to-[var(--primary-purple)] py-4 text-center font-medium text-base sm:text-lg">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p
              className={`text-sm text-gray-400 transition-all duration-1000 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
            >
            ...
            {/* Social icons */}
            <div
              className={`flex flex-wrap gap-4 transition-all duration-1000 delay-300 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
            >
              {socialLinks.map((social, index) => {
                ...
                return (
                  <a
                    ...
                    target="_blank"
                    rel="noopener"
                    className={`group relative flex items-center justify-center w-12 h-12 rounded-xl bg-[var(--bg-surface)]/50 border border-[rgba(255,255,255,0.1)]/50 text-gray-400 ${social.color} transition-all duration-300 hover:bg-gray-700/50 hover:scale-110 hover:border-blue-500/50 hover:shadow-lg`}
            ...
            <div
              className={`flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-6 transition-all duration-1000 delay-400 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
            >
              {/* Selo Reclame Aqui */}
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-gray-400 hover:text-[var(--primary-purple-light)] transition-colors duration-300 hover:translate-x-1 inline-block"
                >
                  Notícias
                </a>
              </li>
          ...
          {/* Coluna: Recursos */}
          <div
            className={`transition-all duration-1000 delay-400 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
          >
      ...
      {/* Barra inferior */}
      <div
        className={`relative bg-[#191a2b] text-center text-xs text-gray-400 py-4 border-t border-gray-800/50 transition-all duration-1000 delay-600 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
