...
export default function PalworldFeatures() {
  ...
  const mainFeatures = [
    {
      id: 'open-world',
      title: 'Mundo aberto incrível.',
      description: 'Explore ambientes diversos com gráficos vibrantes e detalhados.',
      icon: <Globe className="h-8 w-8" />,
      gradient: 'from-blue-500 to-cyan-500',
      stats: { value: '100%', label: 'Liberdade Total' },
      details: ['Ambientes variados', 'Exploração dinâmica', 'Flora e fauna únicas']
    },
    {
      id: 'creatures',
      title: 'Captura e treino de Pals.',
      description: 'Colete, treine e utilize criaturas fantásticas para batalhas e trabalho.',
      icon: <Users className="h-8 w-8" />,
      gradient: 'from-purple-500 to-pink-500',
      stats: { value: '50+', label: 'Espécies de Pals' },
      details: ['Treinamento detalhado', 'Criação e cultivo', 'Batalhas estratégicas']
    },
    {
      id: 'multiplayer',
      title: 'Modo multiplayer interativo.',
      description: 'Jogue com amigos, construa juntos e enfrente desafios cooperativos.',
      icon: <Server className="h-8 w-8" />,
      gradient: 'from-green-500 to-emerald-500',
      stats: { value: '24/7', label: 'Servidores estáveis' },
      details: ['Canais privados', 'Chat integrado', 'Eventos multiplayer']
    },
    {
      id: 'crafting',
      title: 'Construção e fabricação avançada.',
      description: 'Construa bases, crie equipamentos e explore mecânicas de crafting.',
      icon: <Settings className="h-8 w-8" />,
      gradient: 'from-yellow-500 to-orange-400',
      stats: { value: '200+', label: 'Itens únicos' },
      details: ['Construção modular', 'Fabricação customizada', 'Atualizações regulares']
    }
  ]

  const additionalFeatures = [
    { icon: <Zap className="h-5 w-5" />, title: 'Instalação rápida', desc: 'Pronto para jogar em menos de 1 minuto' },
    { icon: <Database className="h-5 w-5" />, title: 'Salvamento automático', desc: 'Seus dados sempre protegidos' },
    { icon: <Heart className="h-5 w-5" />, title: 'Comunidade ativa', desc: 'Fóruns e suporte dedicado' },
    { icon: <Rocket className="h-5 w-5" />, title: 'Atualizações constantes', desc: 'Novos Pals e recursos frequentes' },
    { icon: <Code className="h-5 w-5" />, title: 'API para desenvolvedores', desc: 'Integre e crie mods facilmente' },
    { icon: <Users className="h-5 w-5" />, title: 'Suporte 24/7', desc: 'Estamos sempre à disposição' }
  ]
  ...
  const plans = [
    {
      name: 'Básico',
      price: '55/mês',
      features: ['8GB RAM', '1 CPU Core', '15GB SSD'],
    ...
    },
    {
      name: 'Avançado',
      price: '70/mês',
      features: ['12GB RAM', '2 CPU Cores', '30GB SSD'],
    ...
    },
    {
      name: 'Premium',
      price: '107/mês',
      features: ['16GB RAM', '4 CPU Cores', '60GB SSD'],
    ...
    },
    {
      name: 'Ultimate',
      price: '170/mês',
      features: ['26GB RAM', '8 CPU Cores', '120GB SSD'],
          ...
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 max-w-9x1 mx-auto mb-16">
            ...
            {plans.map((plan, idx) =>
              ...
              >
                ...
                {/* Ajuste de link para planos (exemplo fictício) */}
                {idx === 0 && (
                  <a
                    href="https://pixelhostbr.com/financeiro/index.php?rp=/store/hospedagem-palworld/basico"
                    className="mt-auto bg-gradient-to-r from-cyan-500 to-blue-600 text-white py-3 rounded-xl font-bold shadow-inner shadow-cyan-900/10 hover:from-cyan-600 hover:to-blue-700 transition-all duration-200 flex justify-center"
                  >
                    Contratar
                  </a>
                )}
                {idx === 1 && (
                  <a
                    href="https://pixelhostbr.com/financeiro/index.php?rp=/store/hospedagem-palworld/avancado"
                    className="mt-auto bg-gradient-to-r from-blue-700 to-indigo-900 text-white py-3 rounded-xl font-bold shadow-inner shadow-blue-900/10 hover:from-blue-800 hover:to-indigo-950 transition-all duration-200 flex justify-center"
                  >
                    Contratar
                  </a>
                )}
                {idx === 2 && (
                  <a
                    href="https://pixelhostbr.com/financeiro/index.php?rp=/store/hospedagem-palworld/premium"
                    className="mt-auto bg-gradient-to-r from-green-600 to-emerald-700 text-white py-3 rounded-xl font-bold shadow-inner shadow-green-900/10 hover:from-green-700 hover:to-emerald-800 transition-all duration-200 flex justify-center"
                  >
                    Contratar
                  </a>
                )}
                {idx === 3 && (
                  <a
                    href="https://pixelhostbr.com/financeiro/index.php?rp=/store/hospedagem-palworld/plano-ultimate"
                    className="mt-auto bg-gradient-to-r from-yellow-600 to-orange-700 text-white py-3 rounded-xl font-bold shadow-inner shadow-yellow-900/10 hover:from-yellow-700 hover:to-orange-800 transition-all duration-200 flex justify-center"
                  >
                    Contratar
                  </a>
                )}
            ...
            <div className="relative flex flex-col items-center text-center rounded-3xl border bg-gradient-to-br from-purple-700/30 to-pink-700/30 shadow-lg border-purple-600 p-7 hover:scale-[1.04] transition-all duration-300 hover:ring-2 hover:ring-pink-400/30">
              ...
              <a
                href="https://pixelhostbr.com/financeiro/index.php?rp=/store/hospedagem-palworld/plano-personalizavel"
