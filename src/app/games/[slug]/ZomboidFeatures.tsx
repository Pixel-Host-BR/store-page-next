        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {additionalFeatures.map((a, idx) => (
              <div
                key={idx}
                className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-[rgba(255,255,255,0.1)]/50 rounded-2xl p-6 hover:border-indigo-500/30 hover:shadow-lg hover:shadow-indigo-500/10 transition-all duration-300 hover:-translate-y-1"
              >
          ...
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 max-w-7xl mx-auto mb-16">
            {plans.map((p, idx) => (
              <div
                key={p.name}
                className={`relative flex flex-col rounded-3xl p-7 border bg-gradient-to-br shadow-lg transition-all duration-300 ${p.grad} border-[rgba(255,255,255,0.1)] hover:scale-[1.04] hover:ring-2 hover:ring-indigo-500/30`}
              >
                {p.badge}
                <h4 className="text-2xl font-bold text-white mb-2">{p.name}</h4>
                <div className="mb-2">
                  <div className="text-3xl font-extrabold text-indigo-400 whitespace-nowrap">
                    R$ {p.price}
                  </div>
                </div>
          ...
          <div className="bg-[var(--bg-surface)]/40 backdrop-blur-sm border border-gray-600/50 rounded-xl p-8 max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="https://pixelhostbr.com/financeiro/index.php?rp=/store/hospedagem-peoject-zomboid" className="btn-primary btn-lg flex-1 flex justify-center">
                  Começar Agora
                </a>
              </div>
            </div>
