...
export default function MinecraftFeatures() {
  ...
  const additionalFeatures = [
    ...
    { icon: <Globe className="h-5 w-5" />, title: 'Subdomínio Grátis', desc: 'seuservidor.pixelhost.com.br' },
          ...
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 max-w-9x1 mx-auto mb-16">
            ...
            {plans.map((plan, idx) =>
              ...
              >
                ...
                <button className="mt-auto bg-gradient-to-r from-green-500 to-emerald-600 text-white py-3 rounded-xl font-bold shadow-inner shadow-green-900/10 hover:from-green-600 hover:to-emerald-700 transition-all duration-200">
                  Contratar
                </button>
              </div>
            )}
            ...
            <div className="relative flex flex-col items-center text-center rounded-3xl border bg-gradient-to-br from-purple-700/30 to-pink-700/30 shadow-lg border-purple-600 p-7 hover:scale-[1.04] transition-all duration-300 hover:ring-2 hover:ring-pink-400/30">
              ...
              <button className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 px-6 rounded-xl font-bold shadow-pink-600/20 transition-all duration-200 hover:from-purple-700 hover:to-pink-700">
                Customizar
              </button>
            </div>
          </div>
